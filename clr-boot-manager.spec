...
Version  : 3.2.8
Release  : 63
URL      : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.8/clr-boot-manager-3.2.8.tar.xz
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.8/clr-boot-manager-3.2.8.tar.xz
...
%prep
%setup -q -n clr-boot-manager-3.2.8
cd %{_builddir}/clr-boot-manager-3.2.8
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585696493
...
cp %{_builddir}/clr-boot-manager-3.2.8/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/clr-boot-manager-3.2.8/src/libnica/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
