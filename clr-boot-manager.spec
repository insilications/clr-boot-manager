...
Version  : 3.2.5
Release  : 60
URL      : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.5/clr-boot-manager-3.2.5.tar.xz
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.5/clr-boot-manager-3.2.5.tar.xz
...
%prep
%setup -q -n clr-boot-manager-3.2.5
cd %{_builddir}/clr-boot-manager-3.2.5
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580323332
...
cp %{_builddir}/clr-boot-manager-3.2.5/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/clr-boot-manager-3.2.5/src/libnica/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
