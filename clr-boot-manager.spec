...
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.1/clr-boot-manager-3.2.1.tar.xz
...
%prep
%setup -q -n clr-boot-manager-3.2.1
cd %{_builddir}/clr-boot-manager-3.2.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575928188
...
cp %{_builddir}/clr-boot-manager-3.2.1/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/clr-boot-manager-3.2.1/src/libnica/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
