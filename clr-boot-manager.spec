...
Version  : 3.0.0
Release  : 39
URL      : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.0.0/clr-boot-manager-3.0.0.tar.xz
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.0.0/clr-boot-manager-3.0.0.tar.xz
...
Requires: clr-boot-manager-license
Requires: clr-boot-manager-man
...
Patch4: 0004-Do-not-fail-an-update-on-efivar-creation-failure.patch
...
%prep
%setup -q -n clr-boot-manager-3.0.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1532653348
...
%install
mkdir -p %{buildroot}/usr/share/doc/clr-boot-manager
cp LICENSE.LGPL2.1 %{buildroot}/usr/share/doc/clr-boot-manager/LICENSE.LGPL2.1
cp src/libnica/LICENSE.LGPL2.1 %{buildroot}/usr/share/doc/clr-boot-manager/src_libnica_LICENSE.LGPL2.1
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/clr-boot-manager/LICENSE.LGPL2.1
/usr/share/doc/clr-boot-manager/src_libnica_LICENSE.LGPL2.1
