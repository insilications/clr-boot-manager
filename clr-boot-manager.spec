...
Version  : 3.2.10
Release  : 67
URL      : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.10/clr-boot-manager-3.2.10.tar.xz
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.10/clr-boot-manager-3.2.10.tar.xz
...
Patch4: 0004-Probe-fallback-if-dev-root-symlink-missing.patch
...
%prep
%setup -q -n clr-boot-manager-3.2.10
cd %{_builddir}/clr-boot-manager-3.2.10
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648509767
...
cp %{_builddir}/clr-boot-manager-3.2.10/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/clr-boot-manager-3.2.10/src/libnica/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
