...
%prep
%setup -q -n clr-boot-manager-3.2.9
cd %{_builddir}/clr-boot-manager-3.2.9
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
cp %{_builddir}/clr-boot-manager-3.2.9/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/clr-boot-manager-3.2.9/src/libnica/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
