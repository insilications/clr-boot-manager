...
Version  : 3.2.3
Release  : 58
URL      : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.3/clr-boot-manager-3.2.3.tar.xz
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.3/clr-boot-manager-3.2.3.tar.xz
...
%prep
%setup -q -n clr-boot-manager-3.2.3
cd %{_builddir}/clr-boot-manager-3.2.3
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578437918
...
cp %{_builddir}/clr-boot-manager-3.2.3/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/clr-boot-manager-3.2.3/src/libnica/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/clr-boot-manager/01a6b4bf79aca9b556822601186afab86e8c4fbf
